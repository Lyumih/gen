/**
 * Алгоритм генерации врагов и местности
 * 1. Получаем уровень персонажей
 * 1. Генерируем местность
 * 1. Генерируем режим
 * 1. Генерируем погоду
 * 1. Получаем кол-во врагов
 * 1. Получаем уровень врагов
 * 1. Получаем очки умений/характеристик/предметов врагов
